...
# You could compare this to an assembly line in a car factory. The tasks build up, and
# each task can depend on previous tasks being finished. A fictional DAG could look something like this:

# Example DAG

# assemble frame --> place tires
# assemble frame --> assemble_body --> apply_paint

# Assembling the frame happens first, then the body and tires and finally you paint.
